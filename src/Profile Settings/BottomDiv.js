    ...
    <div className="w-full bg-black pt-2">
      <div className="flex justify-between text-gray-400 ml-[10px] mr-[23px]">
        <div className="w-[122px] h-[29px] pl-[13px] pr-2 py-[3px] rounded-[35px] border-neutral-500 justify-center items-center gap-2 inline-flex">
          <div className="w-[25px] h-[25px] relative" onClick={handleBack}>
        ...
        <div className="flex gap-[10px] items-center">
          ...
          >
            <img src={full_screen} alt="full_screen" />
          </div>
        </div>
      </div>
      <div className="mt-2 flex justify-between mx-5">
        {tools.map((tool) => (
          ...
          >
            <div
              className="p-[15px] bg-neutral-800 rounded-[15px] border backdrop-blur-sm flex justify-center items-center cursor-pointer"
              style={{
                width: "calc(63px * 100%)",
      ...
      <div className="w-auto h-auto border border-zinc-800 mt-[8px] mb-[4px] mx-4"></div>
